<?php
	...
	$title = "A base profile view page";
	$description = "Assignment 3 view member multiple page";
    ...
    if(!isset($db)){
        ...
        /* Note: ERROR >>> it can't serialize a datatype of resource(object or pdo connection), same as you can't serialize a file handle.
         * solve problem source: https://stackoverflow.com/questions/27794597/i-never-use-pdo-serialize-or-unrealize-but-i-got-this-error-you-cannot-serial
         *
	    // session is started if you don't write this line can't use $_Session  global variable
	    // In this session, it will limit the amount of time users are allowed to view this page
	    session_start();
        $_SESSION['view_db_obj'] = $db;
        */
    }
    ...
    if(isset($_GET['deleteId']) && !empty($_GET['deleteId'])) {
        ...
        $db->deleteDataById($tableName, $deleteId);
    }
...
<section class="container">
    <form class="form-inline d-flex justify-content-center mt-2" action="viewMember_multiple.php" method="post">
			...
			<div class="col-md-7">
				<div class="card p-3 py-4">
					<div class="text-center">
						<img src="<?php $value['profile_img_path']; ?>" width="100" class="rounded-circle" alt="<?php $value['profile_img_name']; ?>">
					</div>
					<div class="text-center mt-3">
						...
						<div class="buttons">
							<button class="btn btn-primary px-4"><a href="updateProfile.php?updateId=<?php echo $value['id']; ?>">
                                    Update</a></button>
                            <button class="btn btn-danger px-4 ms-3"><a href="viewMember_multiple.php?deleteId=<?php echo $value['id']; ?>">Delete</a></button>
						</div>
					</div>
				</div>
			</div>
...
?>
    ...
    <section class="container no-data-section">
        ...
        <h2 class="text-center">No Profile Data</h2>
    </section>
    <?php
}
?>
